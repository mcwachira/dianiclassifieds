         ...
         <!-- Session Status -->
                ...
                <form action="{{ route('admin.login') }}" method="POST" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" class="form-control" placeholder="your@email.com" name="email" :value="old('email')" required autofocus autocomplete="username" />
                    ...
                    <a href={{route('admin.password.request')}}>I forgot password</a>
                        ...
                        <div class="input-group input-group-flat">
                            <input type="password" class="form-control" placeholder="Your password"   name="password" required autocomplete="current-password" />
