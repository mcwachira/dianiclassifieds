            ...
            <div class="card-body">
                ...
                <input type="hidden" name="token" value="{{ $request->route('token') }}">
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" class="form-control" placeholder="your@email.com"  name="email" value="{{old('email', $request->email)}}" required autofocus autocomplete="username" />
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group input-group-flat">
                            <input type="password" id="password" class="form-control" placeholder="Your password"   name="password" required autocomplete="new-password" />
                    ...
                    ><!-- Download SVG icon from http://tabler.io/icons/icon/eye -->
                      ...
                      ></a>
                        ...
                        <div class="input-group input-group-flat">
                            <input type="password" id="password_confirmation" class="form-control" placeholder="Confirm Your password"   name="password_confirmation" required autocomplete="new-password"  />
