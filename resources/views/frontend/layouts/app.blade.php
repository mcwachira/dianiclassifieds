                        ...
                        <div class="detail-gallery">
                            ...
                            <div class="product-image-slider">
                                <figure class="border-radius-10">
                                    <img src="{{asset('assets/frontend/assets/imgs/shop/product_slider_b1.png')}}" alt=" product image" />
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="{{asset('assets/frontend/assets/imgs/shop/product_slider_b2.png')}}" alt=" product image" />
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="{{asset('assets/frontend/assets/imgs/shop/product_slider_b3.png')}}" alt=" product image" />
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="{{asset('assets/frontend/assets/imgs/shop/product_slider_b4.png')}}" alt=" product image" />
                                </figure>
                                <figure class="border-radius-10">
                                    <img src="{{asset('assets/frontend/assets/imgs/shop/product_slider_b1.png')}}" alt=" product image" />
                                </figure>
                            ...
                            <div class="slider-nav-thumbnails">
                                <div><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-3.jpg')}}" alt="product image" /></div>
                                <div><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-4.jpg')}}" alt="product image" /></div>
                                <div><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-5.jpg')}}" alt="product image" /></div>
                                <div><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-6.jpg')}}" alt="product image" /></div>
                                <div><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-7.jpg')}}" alt="product image" /></div>
                                <div><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-8.jpg')}}" alt="product image" /></div>
                                <div><img src="{{asset('assets/frontend/assets//imgs/shop/thumbnail-9.jpg')}}" alt="product image" /></div>
                            </div>
                        </div>
                        <!-- End Gallery -->
                    </div>
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="#">
                                    <img class="svgInject" alt="ShopX" src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-compare.svg')}}" />
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="#">
                                    <img alt="ShopX" src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-cart.svg')}}" />
                                    ...
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt="ShopX" src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-3.jpg')}}" /></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt="ShopX" src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-2.jpg')}}" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="index.html" src="{{asset('assets/frontend/assets/imgs/theme/logo.svg')}}" alt="logo" /></a>
                </div>
                        ...
                        <div
                            ...
                            <div class="d-flex categori-dropdown-inner">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-1.svg')}}" alt="" />
                                            Men's Clothing
                                        </a>
                                        <ul>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-2.svg')}}" alt="" />
                                            Women's Clothing
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-3.svg')}}" alt="" />
                                            Jewelry & Fashion
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-4.svg')}}" alt="" />
                                            Sports Apparel
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-5.svg')}}" alt="" />
                                            Skincare
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-6.svg')}}" alt="" />
                                            Exercise & Fitness
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-7.svg')}}" alt="" />
                                            Toys & Games
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-8.svg')}}" alt="" />
                                            Sunglasses
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/category-9.svg')}}" alt="" />
                                            Denim Collection
                                        </a>
                                        <ul>
                                            <li><a href="#">Menu 01</a></li>
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                ...
                                <li class="hot-deals">
                                    <!-- <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-hot-white.svg')}}" alt="hot deals"> -->
                ...
                <div class="hotline d-none d-lg-flex">
                    <img  src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-headphone-white.svg')}}" alt="hotline" />
                    ...
                    <div class="header-action-2">
                        <div class="header-action-icon-2">
                            <a href="shop-wishlist.html">
                                <img alt="ShopX" src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-heart.svg')}}" />
                        ...
                        <div class="header-action-icon-2">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="ShopX" src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-4.jpg')}}" /></a>
                                        </div>
                                        <div class="shopping-cart-title">
    ...
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-social-icon mb-50">
                ...
                <a href="#"><img  src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-facebook-white.svg')}}" alt="" /></a>
                <a href="#"><img  src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-twitter-white.svg')}}" alt="" /></a>
                <a href="#"><img  src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-instagram-white.svg')}}" alt="" /></a>
                <a href="#"><img  src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-pinterest-white.svg')}}" alt="" /></a>
                <a href="#"><img  src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-youtube-white.svg')}}" alt="" /></a>
            </div>
                    ...
                    <div class="home-slide-cover mt-30">
                        <div class="hero-slider-1 style-5 dot-style-1 dot-style-1-position-2">
                            <div class="single-hero-slider single-animation-wrap"
                                 style="background-image: url(../../../../public/assets/frontend/assets/imgs/slider/slider-7.png)">
                            ...
                            <div class="single-hero-slider single-animation-wrap"
                                 style="background-image: url(../../../../public/assets/frontend/assets/imgs/slider/slider-8.png)">
                                <div class="slider-content">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-12">
                            <div class="banner-img style-4 mt-30">
                                <img  src="{{asset('assets/frontend/assets/imgs/banner/banner-14.png')}}" alt="" />
                        ...
                        <div class="col-12 col-md-6 col-lg-12">
                            <div class="banner-img style-5 mt-5 mt-md-30">
                                <img  src="{{asset('assets/frontend/assets/imgs/banner/banner-15.png')}}" alt="" />
                                <div class="banner-text">
                ...
                <div class="carausel-10-columns" id="carausel-10-columns">
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-13.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-12.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-11.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-9.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-3.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-1.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-2.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-4.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img  src="{{asset('assets/frontend/assets/imgs/shop/cat-5.png')}}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{asset('assets/frontend/assets/imgs/shop/cat-14.png')}}" alt="" /></a>
                        </figure>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-1.png')}}" alt="" />
                        <div class="banner-text">
                            <h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-2.png')}}" alt="" />
                        <div class="banner-text">
                            <h4>
                ...
                <div class="col-lg-4 d-md-none d-lg-flex">
                    <div class="banner-img mb-sm-0 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-3.png')}}" alt="" />
                        <div class="banner-text">
                            ...
                            <div class="product-cart-wrap mb-30" data-wow-delay=".1s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-1-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-1-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30" data-wow-delay=".2s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-2-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-2-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30" data-wow-delay=".3s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-3-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-3-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30" data-wow-delay=".4s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-4-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-4-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30" data-wow-delay=".5s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-5-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-5-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap" data-wow-delay=".1s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-6-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-6-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap" data-wow-delay=".2s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-7-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-7-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap" data-wow-delay=".3s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-8-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-8-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap" data-wow-delay=".4s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#" tabindex="-1">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-9-1.jpg')}}" alt="">
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-9-2.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Add To Wishlist" class="action-btn"
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-9-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-9-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-8-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-8-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-7-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-7-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-6-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-6-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-5-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-5-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-4-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-4-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-3-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-3-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-2-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-2-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 col-xl-3 col-xxl-2">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-1-1.jpg')}}"
                                                 alt="" />
                                            <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-1-2.jpg')}}" alt="" />
                                        </a>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-16.png')}}" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-17.png')}}" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-18.png')}}" alt="" />
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="banner-img style-6 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-19.png')}}" alt="" />
                        <div class="banner-text">
            ...
            <div class="row">
                <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                    <div class="banner-img style-2">
                        <img src="{{asset('assets/frontend/assets/imgs/banner/banner-4.png')}}" alt="">
                        <div class="banner-text">
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="#">
                                                    <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-1-1.jpg')}}"
                                                         alt="" />
                                                    <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-1-2.jpg')}}"
                                                         alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="#">
                                                    <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-5-1.jpg')}}"
                                                         alt="" />
                                                    <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-5-2.jpg')}}"
                                                         alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="#">
                                                    <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-2-1.jpg')}}"
                                                         alt="" />
                                                    <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-2-2.jpg')}}"
                                                         alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="#">
                                                    <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-3-1.jpg')}}"
                                                         alt="" />
                                                    <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-3-2.jpg')}}"
                                                         alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="#">
                                                    <img class="default-img" src="{{asset('assets/frontend/assets/imgs/shop/product-4-1.jpg')}}"
                                                         alt="" />
                                                    <img class="hover-img" src="{{asset('assets/frontend/assets/imgs/shop/product-4-2.jpg')}}"
                                                         alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
            ...
            <div class="row">
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-1.jpg')}}" alt="" /></a>
                            </figure>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-2.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                                    <a href="#">Classic Slim-Fit Denim Jeans – Men's Stretchable Mid-Rise</a>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-3.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                                    <a href="#">Classic Slim-Fit Denim Jeans – Men's Stretchable Mid-Rise</a>
                ...
                <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-4.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-5.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-6.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                ...
                <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-7.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-8.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-9.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                ...
                <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-10.jpg')}}"  alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-11.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-sm-4 mb-0">
                                <a href="#"><img src="{{asset('assets/frontend/assets/imgs/shop/thumbnail-12.jpg')}}" alt="" /></a>
                            </figure>
                            <div class="col-sm-8 mb-0">
                                <h6>
...
<footer class="main pt-10">
    <section class="newsletter mb-15 wow animate__animated animate__fadeIn">
        <div class=" container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="newsletter_bg" style="background:url(../../../../public/assets/frontend/assets/imgs/banner/banner-9.png);">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                        ...
                        <div class="banner-icon">
                            <img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-1.png')}}" alt="" />
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                         data-wow-delay=".1s">
                        <div class="banner-icon">
                            <img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-2.png')}}" alt="" />
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                         data-wow-delay=".2s">
                        <div class="banner-icon">
                            <img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-3.png')}}" alt="" />
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-3 col-lg-4 col-12 col-sm-6">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                         data-wow-delay=".4s">
                        <div class="banner-icon">
                            <img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-5.png')}}" alt="" />
                        </div>
                        <div class="banner-text">
                ...
                <div class="col-xl-3">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="logo mb-30">
                            <a href="index.html" class="mb-15"><img src="{{asset('assets/frontend/assets/imgs/theme/logo.svg')}}"
                                                                    alt="logo" /></a>
                            <p class="font-lg text-heading">Awesome eCommerce store website template</p>
                        </div>
                        <ul class="contact-infor">
                            <li><img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-location.svg')}}" alt="" /><strong>Address:
                                </strong> <span>233 North Michigan Avenue, Suite 1800, Chicago, IL 60601</span>
                            </li>
                            <li><img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call
                                    Us:</strong><span>+9625415 546666464</span></li>
                            <li><img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-email-2.svg')}}"
                                     alt="" /><strong>Email:</strong><span>sale@shopx.com</span></li>
                            <li><img src="{{asset('assets/frontend/assets/imgs/theme/icons/icon-clock.svg')}}"
...
<script src="{{asset('assets/frontend/assets/js/plugins/slider-range.js')}}"></script>
<script src="{{asset('assets/frontend/assets/js/plugins/jquery-ui.js')}}"></script>
<script src="{{asset('assets/frontend/assets/js/plugins/custom-parallax.js')}}"></script>
<script src="{{asset('assets/frontend/assets/js/plugins/leaflet.js')}}"></script>
<script src="{{asset('assets/frontend/assets/js/plugins/TweenMax.min.js')}}"></script>
<!-- Template  JS -->
<script src="{{asset('assets/frontend/assets/js/main.js')}}"></script>
<script src="{{asset('assets/frontend/assets/js/shop.js')}}"</script>
</body>
